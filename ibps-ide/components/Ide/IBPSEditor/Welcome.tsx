...
const Welcome = () => {
  return (
    <div className="flex h-full w-full select-text flex-col gap-5 overflow-y-auto bg-idelight-whitish p-10 pb-20 dark:bg-idedark-1000">
      ...
      <p>
        Use the <b>files pane</b> on the left-hand side to create, rename, delete, import,
        or export any IBPS files. Use this pane to edit the selected file. All progress is
        automatically saved on your computer.
      </p>
      <p>
        Finally, click the "Run" button above to run the code in the active file. The{" "}
        <b>output</b> will be shown on the <b>output pane</b> to the right.
      </p>
      ...
      <div className="pt-5 text-idelight-400 dark:text-idedark-400">
        <p>
